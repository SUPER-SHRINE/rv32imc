...
impl Cpu {
    pub(super) fn decode_i_type(&self, inst_bin: u32) -> (usize, usize, u32, u32) {
    ...
    pub(super) fn decode_b_type(&self, inst_bin: u32) -> (usize, usize, u32, u32) {
    ...
    pub(super) fn decode_r_type(&self, inst_bin: u32) -> (usize, usize, usize, u32, u32) {
